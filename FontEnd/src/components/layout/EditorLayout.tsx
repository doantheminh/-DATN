...
import { MdCategory, MdDashboard, MdOutlineProductionQuantityLimits } from 'react-icons/md';
...
const EditorLayout = () => {
    ...
    const items: MenuProps['items'] = [
        {
            label: (
                <Link className="text-base" to={'/nhanvien/view_account'}>
                    Cá nhân
                </Link>
            ),
            key: '0',
    ...
    return (
        <>
            {isLoading || (!isLoading && authData?.role !== 'nhanvien') ? (
                <Loading />
            ) : (
                <div>
                            ...
                            <ul className="space-y-2 font-medium">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 ml-3 whitespace-nowrap">Quản lý mã giảm giá</span>
                                    </Link>
                                </li>
