        ...
        <>
            {currentProduct ? (
                ...
                >
                    ...
                    <Form.Item name="sale_off" label="Giảm giá">
                        <InputNumber placeholder="Vui lòng gõ giảm giá" style={{ width: '100%' }} min={0} />
                    </Form.Item>
                    ...
                    <Form.Item label="Chọn kích thước" rules={[{ required: true, message: 'Vui lòng chọn size' }]}>
